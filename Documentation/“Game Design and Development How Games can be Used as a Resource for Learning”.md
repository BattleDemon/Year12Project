...
This report investigates the use and effects of games as a resource for learning, with a specific focus on their application within IT and History education. The guiding line of enquiry driving this investigation is: _"How can research into game-based learning and grand strategy game design be applied to create a historically grounded simulation that passively educates a general audience about Merovingian Francia?"_ The final product developed for this project is a grand strategy video game set during the Merovingian rule of Francia, designed to present historical content in a way that is consistent with the research findings. This report outlines the research undertaken across the areas of game-based learning and game design, examines how those ideas were translated into practice, and documents the development process, planning, and decision-making that shaped the product. 
